    ...
    children: [
      {
        path: "vitals",
        name: "vitals",
        meta: { title: 'Signos Vitales', back: true, requiresAuth: true },
        component: () => import(/* webpackChunkName: "Vitals" */ "../views/Vitals"),
      },
      {
        path: "triage",
        name: "triage",
        meta: { title: 'Triage', back: true, requiresAuth: true },
        component: () => import(/* webpackChunkName: "Triage" */ "../views/Triage"),
      },
      {
        path: "covid",
        name: "covid",
        meta: { title: 'Covid', back: true, requiresAuth: true },
        component: () => import(/* webpackChunkName: "Covid" */ "../views/Covid"),
      },
      {
        path: "probability",
        name: "probability",
        meta: { title: 'Probability', back: true, requiresAuth: true },
        component: () => import(/* webpackChunkName: "Probability" */ "../views/Probability"),
      },
      {
        path: "laboratorios",
        name: "labs",
        meta: { title: 'Laboratorios', back: true, requiresAuth: true },
        component: () => import(/* webpackChunkName: "Laboratorios" */ "../views/Laboratorios"),
      },
      {
        path: "medical-notes",
        name: "notes",
        meta: { title: 'Notas Medicas', requiresAuth: true },
